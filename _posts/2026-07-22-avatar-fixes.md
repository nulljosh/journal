...
Also addressed Lexly's App Store rejection—Apple wanted confirmation that the app has no paywalls (it doesn't) and an end to forcing sign-in before the free quiz content appears. Removed the login gate and replied to both issues. Builds clean on iOS and macOS; uploading and resubmitting is the next step.
