...
Separately, built a /duolingo skill (public endpoint, no login) to collect XP, streak, and per-course progress, appending snapshots to a JSONL feed for Lexly's data import. Baseline on nulljosh: 45,160 XP, 143-day streak since 2014-01-06, 25 courses (Spanish 8,779 and German 8,758 leading).
