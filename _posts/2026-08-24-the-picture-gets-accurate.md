...
Renamed Wiretext to Charwork (repo, folder, GitHub org) and restyled the iOS app from dark editorial to warm and usable: cream ground, soft paper canvas, dark ink, terracotta accent, rounded corners. Shipped it all.
Spam wave hit the account: six apps flagged for batch-submitting, appeals filed for the three strongest plus Healstack. Fixed Epiphany's native sign-in sheet error by pulling the button, rewrote Lexly's listing to reduce fingerprinting, lightened Curvely's landing page overlay. Renamed Wiretext to Charwork and restyled the iOS app with warm tones and rounded corners. Sidewise (Newsline) reached the finish line with age rating set, screenshots shipped, binaries validated, but submission held because seven apps sit rejected under the 4.3(a) spam wave with appeals pending, and submitting now would undercut those replies.
