...
Pwnlingo: aria-disabled and skip-heuristic bugs fixed, zero XP recovery, per-cycle detector tally logging. Seamark: grid clustering engine ported. Epiphany: version bump + screenshots + App Review resubmission. All runners live and unattended.
