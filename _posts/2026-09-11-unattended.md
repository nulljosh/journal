...
Also audited the nulljosh repos for README badge consistency, patching 11 repos missing license or GitHub badges and adding badge lines to 3 repos that had none, all via the GitHub API.
